...
-- The function that moves the bird across the screen
local function moveBird()
    bird.x = bird.x + scrollXSpeed
    bird.y = bird.y + scrollYSpeed
end
...
function scene:create( event )
    ...
    -- Insert the bird image
    bird = display.newImageRect("Images/CompanyLogoRyoma.png", 200, 200)

    -- set the initial x and y position of the bird
    bird.x = 100
